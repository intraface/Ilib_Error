 ...
 *
 * @category User error management
 * @package  Error
...
$pfm->setPackage('Ilib_Error');
$pfm->setSummary('User error management');
$pfm->setDescription('Class is used to collect and show errors for the user.');
